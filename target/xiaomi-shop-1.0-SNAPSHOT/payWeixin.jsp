				...
				<div class="panel panel-default"  style="margin: 0 auto;width: 95%;">
				  <div class="panel-heading">
				    <h3 class="panel-title"><span class="glyphicon glyphicon-yen"></span>&nbsp;&nbsp;在线支付
				    	<span class="pull-right"><a href="${pageContext.request.contextPath }/order?method=show">返回订单列表</a>
				    	</span>
				    </h3>
				  </div>
				  <div class="panel-body">	 
					...
					<table class="table table-bordered table-striped table-hover">
						...
						<tr>
							...
							<td colspan="3">
								<div class="input-group" style="width: 200px;"><%--${param.money}--%>
							      <input type="text" class="form-control"  name="price" value="1" readonly="readonly">
