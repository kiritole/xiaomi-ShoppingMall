...
<script type="text/javascript">
	...
	function sub(cid,cnum,price){
		...
		if (cnum == 1){
			...
			{
				location.href = "cart?method=deleteById&cid="+cid;
			}
		}else{
			cnum--;
	...
	function clearCart(uid){
		if (confirm("是否要清空购物车！"))
		{
			location.href = "cart?method=clearCart&uid="+uid;
		}
	}
</script>
</head>
...
<div class="container" style="background-color: white;">
	...
	<div class="row">
		<div class="pull-right" style="margin-right: 40px;">
	            ...
	            <div>
	            	<a id="removeAllProduct" href="javascript:;"   onclick="clearCart(${userNow.id})" class="btn btn-default btn-lg">清空购物车</a>
	            	&nbsp;&nbsp;
	            	<a href="${pageContext.request.contextPath}/order?method=orderPreView&uid=${userNow.id}" class="btn  btn-danger btn-lg">去结算</a>
